...
while True:
    pri_cur= input('>>Please enter the country name of primary currency you want to convert: \n').capitalize()
    if pri_cur in currencycodes.keys(): break
    else:
        pri_cur= input('>>Make sure you type the spellings are right: \n')
    
while True:
    sec_cur = input('>>Please enter the country name of secondary currency you want to convert: \n').capitalize()
    if sec_cur in currencycodes.keys(): break    
    else:
      sec_cur = input('>>Make sure you type the spellings are right: \n')
    
while True:
    try:
        value = int(input(f'>>>>>How much of {pri_cur} do you want to convert to {sec_cur}, please avoid "," or ".". Enter just numbers alone: \n'))
        break
    except:
        continue

answer = (value/data["quotes"]["USD"+currencycodes[pri_cur]])*data["quotes"]["USD"+currencycodes[sec_cur]]
print('\n')
print(f"Converting the currancy of {pri_cur} {value} to currancy of {sec_cur}.\n")

print(f"The value of {sec_cur} currency = {answer}.",'\n' )
