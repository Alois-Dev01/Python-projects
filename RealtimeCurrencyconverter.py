...
while True:
    pri_cur= input('>>>Please enter the ISO-4217 code of primary currency you want to convert: ')
...
while True:
    sec_cur = input('>>>Please enter the ISO-4217 code of secondary currency you want to convert: ')
